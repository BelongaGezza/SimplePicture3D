...
**Fix:** Changed winding to tl->tr->bl (triangle 1) and tr->br->bl (triangle 2). Cross product now produces +Z outward normals. Test `triangulate_grid_ccw_winding_check` verifies this. **ADR-008 in RESEARCH/architecture.md updated 2026-02-28 to match the implemented winding.**
